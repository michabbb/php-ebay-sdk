...
/**
 * This class stands for FindItemsIneBayStoresResponse StructType
...
class FindItemsIneBayStoresResponse extends BaseFindingServiceResponse
{
     ...
     * narrowed your search based on specific conditions.<br> <br> Only returned when you search the eBay US site. International items in US search results are included in the histogram counts.
     * - maxOccurs: 1
     * - minOccurs: 0
    ...
    /**
     * Constructor method for FindItemsIneBayStoresResponse
     * @uses FindItemsIneBayStoresResponse::setCategoryHistogramContainer()
     * @uses FindItemsIneBayStoresResponse::setAspectHistogramContainer()
     * @uses FindItemsIneBayStoresResponse::setConditionHistogramContainer()
     ...
     * @param \macropage\ebaysdk\finding\StructType\CategoryHistogramContainer $categoryHistogramContainer
     * @return \macropage\ebaysdk\finding\StructType\FindItemsIneBayStoresResponse
     */
