...
class ListingDurationCodeType extends AbstractStructEnumBase
{
     ...
     * listing. <br> <br> <span class="tablenote"><b>Note: </b> The <code>GTC</code> (Good 'Til Cancelled) value is the only supported listing duration for fixed-price listings on all eBay marketplaces and categories except for motor vehicle listings on
     * eBay Motors US, and on the eBay UK and eBay Italy sites. </span> <br> <span class="tablenote"><b>Note: </b> As long as a fixed-price listing has inventory available, or if the out-of-stock control feature is being used, GTC listings are automatically
     * renewed each month according to the calendar day. </span>
     * @return string 'GTC'
     */
    const VALUE_GTC = 'GTC';
    /**
