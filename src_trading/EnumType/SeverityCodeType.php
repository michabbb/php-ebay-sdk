...
class SeverityCodeType extends AbstractStructEnumBase
{
     ...
     * href="https://developer.ebay.com/api-docs/user-guides/static/make-a-call/error-handling.html">Error handling</a> section of the Making a Trading API call guide for more information.
     * @return string 'Error'
     */
