...
class OrderStatusCodeType extends AbstractStructEnumBase
{
     ...
     * href="https://developer.ebay.com/api-docs/user-guides/static/trading-user-guide/manage-fulfill-combine-invoices.html" target="_blank">Combined Invoice</a>, a buyer can request a cancellation, and/or a seller can update payment details (including a
     * change in order price) or shipping details (including shipping cost and shipping service). <br><br> This value can be used a filter value in the <b>OrderStatus</b> field of the <b>GetOrders</b> request payload, and it can also be returned in any of
