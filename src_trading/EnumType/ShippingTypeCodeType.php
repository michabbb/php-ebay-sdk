...
class ShippingTypeCodeType extends AbstractStructEnumBase
{
     ...
     * href="https://developer.ebay.com/api-docs/user-guides/static/trading-user-guide/shipping-types-rates.html#SpecifyingFreightShipping">Specifying Freight Shipping</a> in the eBay Features Guide. </span>
     * @return string 'Flat'
     */
     ...
     * that you can specify via API, see <a href="https://developer.ebay.com/api-docs/user-guides/static/trading-user-guide/shipping-freight.html" target="_blank"> Freight shipping</a> in the Trading API User Guide. </span>
     ...
     * details about freight shipping, see <a href="https://developer.ebay.com/api-docs/user-guides/static/trading-user-guide/shipping-freight.html" target="_blank">Freight shipping</a> in the Trading API User Guide.
