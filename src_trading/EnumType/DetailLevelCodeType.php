...
class DetailLevelCodeType extends AbstractStructEnumBase
{
     ...
     * Meta information extracted from the WSDL
     * - documentation: Returns the summary data. For <b>GetMyMessages</b>, this detail level returns the same data whether or not you include <b>MessageIDs</b> in the request. Returns up to 10 <b>FolderID</b> and <b>FolderName</b> values. Currently, this
     * detail level is the only way to retrieve <b>FolderID</b> and <b>FolderName</b> values. See <b>GetMyMessages</b> for a code sample that demonstrates this.
     ...
     * Meta information extracted from the WSDL
     * - documentation: Returns message headers. For <b>GetMyMessages</b>, if you include <b>MessageIDs</b> in the request, this detail level returns header information, without body text, for the specified message ID or alert ID values. If you include a
     * <b>FolderID</b>, header information is returned only for the messages and alerts in the specified folder.<br/><br/> If you do not include <b>MessageIDs</b>, this detail level returns header information for Alerts and Messages as follows: <ul> <li>If
     * all the Alerts have been read, they are sorted in date order, with the most recent first.</li> <li>If one of the Alerts has not been read, the Read Alerts come first, sorted most recent first, followed by the Unread Alert(s).</li> <li>All messages in
     * ascending order by date received with the oldest messages first.</li> </ul> <br/> <span class="tablenote"><b>Note:</b> Even when restricted by this detail level to return only header information, <b>GetMyMessages</b> may return a high volume of data.
     * </span>
     ...
     * Meta information extracted from the WSDL
     * - documentation: Returns full message information. For <b>GetMyMessages</b>, if you include <b>MessageIDs</b> in the request, this detail level returns message information for the specified message ID or alert ID values. If you include a
     * <b>FolderID</b>, message information is returned only for the messages and alerts in the specified folder.
