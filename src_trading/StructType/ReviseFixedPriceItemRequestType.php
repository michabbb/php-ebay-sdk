...
class ReviseFixedPriceItemRequestType extends AbstractRequestType
{
     ...
     * <b>Variations</b> container) can't be deleted by using <b>DeletedField</b>. See the relevant field descriptions for how to delete such data. <br><br> Use values that match the case of the schema element names (<b>Item.PictureDetails.PictureURL</b>)
     * or make the initial letter of each field name lowercase (<b>item.pictureDetails.pictureURL</b>). However, do not change the case of letters in the middle of a field name. For example, <b>item.picturedetails.pictureUrl</b> is not allowed. <br><br> To
