...
class RelistItemResponseType extends AbstractResponseType
{
     ...
     * The EndTime
     * Meta information extracted from the WSDL
     * - documentation: This timestamp indicates the date and time when the relisted item is scheduled to end on the eBay site. This date/time is calculated by using the <b>StartTime</b> and the listing duration. GTC listings are automatically renewed each
     * month according to the calendar day.
     * - minOccurs: 0
     * @var string|null
     */
