...
class LocalListingDistancesSpecialtyDefinitionType extends AbstractStructBase
{
     ...
     * @uses \DOMNode::item()
     * @uses \macropage\ebaysdk\trading\StructType\LocalListingDistancesSpecialtyDefinitionType::setAny()
     ...
     * Set any value
     * @param \DOMDocument $any
     * @return \macropage\ebaysdk\trading\StructType\LocalListingDistancesSpecialtyDefinitionType
     */
