...
class RelistFixedPriceItemResponseType extends AbstractResponseType
{
     ...
     */
    public function __construct($itemID = null, $sKU = null, \macropage\ebaysdk\trading\StructType\FeesType $fees = null, $startTime = null, $endTime = null, $categoryID = null, $category2ID = null, array $discountReason = array(), \macropage\ebaysdk\trading\StructType\ProductSuggestionsType $productSuggestions = null, \macropage\ebaysdk\trading\StructType\ListingRecommendationsType $listingRecommendations = null)
    {
        $this
            ->setItemID($itemID)
            ->setSKU($sKU)
     ...
     * Set ItemID value
     * @param string $itemID
     * @return \macropage\ebaysdk\trading\StructType\RelistFixedPriceItemResponseType
     */
    ...
    public function setDiscountReason(array $discountReason = array())
    {
        ...
        foreach ($discountReason as $relistFixedPriceItemResponseTypeDiscountReasonItem) {
            if (!\macropage\ebaysdk\trading\EnumType\DiscountReasonCodeType::valueIsValid($relistFixedPriceItemResponseTypeDiscountReasonItem)) {
                $invalidValues[] = var_export($relistFixedPriceItemResponseTypeDiscountReasonItem, true);
            }
        }
