...
class GetOrdersRequestType extends AbstractRequestType
{
     ...
     * date range filters are ignored if specified in the request. <br><br> <span class="tablenote"><b>Note: </b> The identifier for an order will change as it goes from unpaid to paid status, and both values are supported in <b>OrderID</b> fields. </span>
     * <br>
     * - minOccurs: 0
     ...
     * The ListingType
     * Meta information extracted from the WSDL
     * - documentation: Use this field if you wish to only retrieve orders spawned from a specific listing type such as auction or fixed price.<br><br>See <a href="https://developer.ebay.com/Devzone/XML/docs/Reference/eBay/types/ListingTypeCodeType.html"
     * target="_blank">ListingTypeCodeType</a> for supported values.
     * - minOccurs: 0
     * @var string|null
     */
