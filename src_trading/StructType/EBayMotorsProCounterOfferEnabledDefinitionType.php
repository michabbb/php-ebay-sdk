...
class EBayMotorsProCounterOfferEnabledDefinitionType extends AbstractStructBase
{
     ...
     * @uses \DOMNode::item()
     * @uses \macropage\ebaysdk\trading\StructType\EBayMotorsProCounterOfferEnabledDefinitionType::setAny()
     ...
     * Set any value
     * @param \DOMDocument $any
     * @return \macropage\ebaysdk\trading\StructType\EBayMotorsProCounterOfferEnabledDefinitionType
     */
