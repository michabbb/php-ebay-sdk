...
class AddItemResponseType extends AbstractResponseType
{
     ...
     */
    public function __construct($itemID = null, $startTime = null, $endTime = null, \macropage\ebaysdk\trading\StructType\FeesType $fees = null, $categoryID = null, $category2ID = null, array $discountReason = array(), \macropage\ebaysdk\trading\StructType\ProductSuggestionsType $productSuggestions = null, \macropage\ebaysdk\trading\StructType\ListingRecommendationsType $listingRecommendations = null)
    {
        $this
            ->setItemID($itemID)
    ...
    {
        $invalidValues = array();
        foreach ($discountReason as $addItemResponseTypeDiscountReasonItem) {
            if (!\macropage\ebaysdk\trading\EnumType\DiscountReasonCodeType::valueIsValid($addItemResponseTypeDiscountReasonItem)) {
                $invalidValues[] = var_export($addItemResponseTypeDiscountReasonItem, true);
            }
        }
