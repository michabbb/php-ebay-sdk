...
class LocalListingDistancesNonSubscriptionDefinitionType extends AbstractStructBase
{
     ...
     * @uses \DOMNode::item()
     * @uses \macropage\ebaysdk\trading\StructType\LocalListingDistancesNonSubscriptionDefinitionType::setAny()
     ...
     * Set any value
     * @param \DOMDocument $any
     * @return \macropage\ebaysdk\trading\StructType\LocalListingDistancesNonSubscriptionDefinitionType
     */
