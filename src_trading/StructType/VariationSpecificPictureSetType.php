...
class VariationSpecificPictureSetType extends AbstractStructBase
{
     ...
     * picture or EPS picture.<br> <br/> <span class="tablenote"><b>Note: </b> All images must comply to the <a href="https://developer.ebay.com/api-docs/user-guides/static/trading-user-guide/pictures.html">Picture Requirements</a>. </span> This is returned
     ...
     */
    public function __construct(?string $variationSpecificValue = null, ?array $pictureURL = null, ?array $externalPictureURL = null, ?\macropage\ebaysdk\trading\StructType\ExtendedPictureDetailsType $extendedPictureDetails = null, $any = null)
    {
        $this
