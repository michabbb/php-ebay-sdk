...
class CrossBorderTradeNorthAmericaEnabledDefinitionType extends AbstractStructBase
{
     ...
     * @uses \DOMNode::item()
     * @uses \macropage\ebaysdk\trading\StructType\CrossBorderTradeNorthAmericaEnabledDefinitionType::setAny()
     ...
     * Set any value
     * @param \DOMDocument $any
     * @return \macropage\ebaysdk\trading\StructType\CrossBorderTradeNorthAmericaEnabledDefinitionType
     */
