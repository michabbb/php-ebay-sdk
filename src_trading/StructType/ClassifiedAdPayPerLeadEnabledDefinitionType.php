...
class ClassifiedAdPayPerLeadEnabledDefinitionType extends AbstractStructBase
{
     ...
     * @uses \DOMNode::item()
     * @uses \macropage\ebaysdk\trading\StructType\ClassifiedAdPayPerLeadEnabledDefinitionType::setAny()
     ...
     * Set any value
     * @param \DOMDocument $any
     * @return \macropage\ebaysdk\trading\StructType\ClassifiedAdPayPerLeadEnabledDefinitionType
     */
