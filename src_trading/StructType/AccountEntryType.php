...
class AccountEntryType extends AbstractStructBase
{
     ...
     * can be only one winning bidder/one sale for an auction listing. <br/><br/> <span class="tablenote"><b>Note: </b> Beginning in July 2024, non-zero transaction IDs will start being returned for auction listings. If necessary, update code to handle
     * non-zero transaction IDs for auction transactions before this time. </span>
     * - minOccurs: 0
     * @var string|null
     */
     ...
     * The OrderId
     * Meta information extracted from the WSDL
     * - documentation: This field is returned if the account fee or credit is associated with an entire (single or multiple line item) order, and not necessarily for a single line item within the order.
     * - minOccurs: 0
     * @var string|null
     */
