...
class PayPalRequiredForStoreOwnerDefinitionType extends AbstractStructBase
{
     ...
     * @uses \DOMNode::item()
     * @uses \macropage\ebaysdk\trading\StructType\PayPalRequiredForStoreOwnerDefinitionType::setAny()
     ...
     * Set any value
     * @param \DOMDocument $any
     * @return \macropage\ebaysdk\trading\StructType\PayPalRequiredForStoreOwnerDefinitionType
     */
