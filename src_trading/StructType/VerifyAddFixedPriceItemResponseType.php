...
class VerifyAddFixedPriceItemResponseType extends AbstractResponseType
{
     ...
     */
    public function __construct(?string $itemID = null, ?string $sKU = null, ?\macropage\ebaysdk\trading\StructType\FeesType $fees = null, ?string $categoryID = null, ?string $category2ID = null, ?array $discountReason = null)
    {
        $this
            ->setItemID($itemID)
            ->setSKU($sKU)
