...
class RefundFailureReasonType extends AbstractStructBase
{
    ...
    public function setRefundFailureCode($refundFailureCode = null)
    {
        ...
        if (!\macropage\ebaysdk\trading\EnumType\RefundFailureCodeType::valueIsValid($refundFailureCode)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $refundFailureCode, implode(', ', \macropage\ebaysdk\trading\EnumType\RefundFailureCodeType::getValidValues())), __LINE__);
        }
     ...
     * @uses \DOMNode::item()
     * @uses \macropage\ebaysdk\trading\StructType\RefundFailureReasonType::setAny()
