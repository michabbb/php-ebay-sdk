...
class Group1MaxFlatShippingCostDefinitionType extends AbstractStructBase
{
     ...
     * @uses \DOMNode::item()
     * @uses \macropage\ebaysdk\trading\StructType\Group1MaxFlatShippingCostDefinitionType::setAny()
     ...
     * Set any value
     * @param \DOMDocument $any
     * @return \macropage\ebaysdk\trading\StructType\Group1MaxFlatShippingCostDefinitionType
     */
