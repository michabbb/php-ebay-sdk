...
class LocalMarketPaymentMethodCheckOutEnabledDefinitionType extends AbstractStructBase
{
     ...
     * @uses \DOMNode::item()
     * @uses \macropage\ebaysdk\trading\StructType\LocalMarketPaymentMethodCheckOutEnabledDefinitionType::setAny()
     ...
     * Set any value
     * @param \DOMDocument $any
     * @return \macropage\ebaysdk\trading\StructType\LocalMarketPaymentMethodCheckOutEnabledDefinitionType
     */
