...
class ClassifiedAdBestOfferEnabledDefinitionType extends AbstractStructBase
{
     ...
     * @uses \DOMNode::item()
     * @uses \macropage\ebaysdk\trading\StructType\ClassifiedAdBestOfferEnabledDefinitionType::setAny()
     ...
     * Set any value
     * @param \DOMDocument $any
     * @return \macropage\ebaysdk\trading\StructType\ClassifiedAdBestOfferEnabledDefinitionType
     */
