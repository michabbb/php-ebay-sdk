...
class AverageRatingDetailsType extends AbstractStructBase
{
    ...
    public function setRatingDetail($ratingDetail = null)
    {
        ...
        if (!\macropage\ebaysdk\shopping\EnumType\FeedbackRatingDetailCodeType::valueIsValid($ratingDetail)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $ratingDetail, implode(', ', \macropage\ebaysdk\shopping\EnumType\FeedbackRatingDetailCodeType::getValidValues())), __LINE__);
        }
     ...
     * @uses \DOMNode::item()
     * @uses \macropage\ebaysdk\shopping\StructType\AverageRatingDetailsType::setAny()
