 ...
 * - documentation: This enumeration type contains a list of standard 3-digit ISO 4217 currency codes for currency used in countries around the world.
...
class CurrencyCodeType extends AbstractStructEnumBase
{
     ...
     * Meta information extracted from the WSDL
     * - documentation: This value is a 3-digit code for an Indian rupee, a currency used in India. This is the value that should be passed in the <b>Item.Currency</b> field by the seller when listing an item on the eBay India site (Site ID 203).
     * @return string 'INR'
     */
    const VALUE_INR = 'INR';
    /**
     ...
     * by the seller when listing an item on the eBay US or US eBay Motors site (Site ID 0). 'USD' can also be specified as the <b>Item.Currency</b> on the eBay Canada site (Site ID 2).
     * @return string 'USD'
     */
    const VALUE_USD = 'USD';
    /**
