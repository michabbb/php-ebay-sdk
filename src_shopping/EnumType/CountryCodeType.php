 ...
 * - documentation: This enumerated type contains a partial list of ISO 3166 standard two-letter codes that represent countries around the world. <br><br> It is recommended that users use the <b>GeteBayDetails</b> call of the Trading API to see the full
 * list of currently supported country codes, and the English names associated with each code (e.g., KY="Cayman Islands"). Call <b>GeteBayDetails</b> with <b>DetailName</b> set to <b>Country</b>, and then look for <b>CountryDetails.Country</b> fields in
 * the response.
...
class CountryCodeType extends AbstractStructEnumBase
{
     ...
     * Meta information extracted from the WSDL
     * - documentation: The Democratic Republic of the Congo.
     * @return string 'CD'
     */
    const VALUE_CD = 'CD';
    /**
